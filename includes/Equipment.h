...
inline const std::array<Armor, 15> Armors = {
    {
        {0, "钢铁胸甲", "坚固的铁制护甲，适合勇敢的战士。",
            150, 50, 0, 5, 5, 0},
        {1, "符文长袍", "带有神秘符文的长袍，增强元气。",
            150, 0, 50, 5, 5, 0},
        {2, "皮革护肩", "轻便的护肩，提供灵活性和基本保护。",
            200, 50, 0, 8, 8, 1},
        {3, "少林僧衣", "穿着简单，能显著提升内力的修炼效果。",
            250, 50, 20, 12, 8, 1},
        {4, "云海翎袍", "带有羽毛装饰，增加使用者的闪避能力。",
            280, 60, 20, 14, 10, 3},
        {5, "天山雪豹甲", "由雪豹皮制成，提供极强的保护和反击能力。",
            300, 60, 20, 15, 10, 3},
        {6, "九阴真经护裙", "传说中的护裙，赋予持有者神秘的力量。",
            500, 70, 40, 15, 15, 5},
        {7, "白虎战甲", "采用白虎皮制作，拥有极高的防御力，适合正义之士。",
            550, 70, 40, 15, 20, 5},
        {8, "流燕斗篷", "背后有流燕图案，轻便灵动，适合追风的侠客。",
            420, 80, 40, 15, 30, 8},
        {9, "天蚕丝甲", "由天蚕丝织成的甲衣，轻便舒适，防御力惊人。",
            500, 80, 40, 22, 30, 8},
        {10, "龙鳞护甲", "传说中龙族遗留下来的护甲，拥有无与伦比的防御力。",
            700, 100, 60, 25, 40, 10},
        {11, "幽冥披风", "来自幽冥之地的神秘披风，赋予佩戴者如幽灵般的闪避能力。",
            800, 100, 70, 25, 50, 10},
        {12, "玄铁重铠", "以玄铁打造的重铠，防御力无可匹敌，适合重型战士。",
            1100, 150, 70, 25, 60, 15},
        {13, "七彩羽衣", "用彩凤的羽毛编织而成，既轻盈又具备强大的防御力。",
            1400, 180, 80, 30, 70, 15},
        {14, "守护之铠", "寄托着守护之神的庇护的铠甲，具有至高的防御力",
