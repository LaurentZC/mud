...
inline std::array<ShopKeeper, 2> ShopKeepers = {
    {
        {"铁匠老李","铁匠老李是一位年长的铁匠，满脸皱纹，手臂结实，常年在炉火旁工作。\n他在江湖上以锻造高质量武器而闻名，尤其擅长打造独特的刀剑。老张性格豪爽，乐于分享自己的锻造经验。",
            {"来吧，年轻人！只要你有心，我就能为你打造出一把无敌的武器！"},{1,2,3,4,5,6,7,9},{0,1,2,3,4,7,8,12},{0,0,0,0,0,0}},
        {"张小翠","张小翠是一位年轻的女商人，经营着一家名为“翠花阁”的小店。\n身材娇小，长发披肩，常常扎成两个可爱的马尾辫。她穿着一身简单却干净的青色衣裙，脸上总是挂着甜美的笑容，给人一种亲切的感觉。",{"你好呀！如果你需要药材或情报，翠花阁绝对是你的最佳选择！"},{},{},{25,30,50,30,40,50}}
    }
};
// @formatter:on
